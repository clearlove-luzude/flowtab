...
urlpatterns = [
    ...
    # 云帆日费用统计页面
    url(r'^day_yf_cost/$', (views.day_yf_cost), name='day_yf_cost'),
    # 云帆日费用统计接口
    url(r'^day_yf_cost_api/$', (views.day_yf_cost_api), name='day_yf_cost_api'),
    # 云帆月费用统计页面
    url(r'^m_yf_cost/$', (views.m_yf_cost), name='m_yf_cost'),
    # 云帆月费用统计接口
    url(r'^m_yf_cost_api/$', (views.m_yf_cost_api), name='m_yf_cost_api'),
]
