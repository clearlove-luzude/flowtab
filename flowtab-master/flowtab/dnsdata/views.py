...
from dnsdata.models import Cdn_bpsdata
from dnsdata.models import Cdn_trafficdata,Cdn_bpsdata,DomainName_tab,Cdn_lookcloud,DomainName_tab_shijie,Controls,Controls_info,Cdn_lookcloud_flow,Domainname_cost
