            ...
            $.ajax({
                ...
                success:function(data){
                 ...
                 for(var a = 0; a<tradata.length;a++){
                    flowarr_time.push(tradata[a][''+'times'+'']);
                    flowarr_http.push(tradata[a][''+'http'+'']);
                 }
                 var traarr_time = new Array;
                 var traarr_http = new Array;
                 for(var a = 0; a<flowdata.length;a++){
                    traarr_time.push(flowdata[a][''+'times'+'']);
                    traarr_http.push(flowdata[a][''+'http'+'']);
                 }
